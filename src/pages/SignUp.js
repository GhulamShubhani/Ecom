...
//   import Header from "../components/Header";
  ...
  const Signup = () => {
    ...
    const sendOtpToNumberAndEmail = async () => {
      try {
    ...
    const handleImage = async (e) => {
      ...
      try {
        const storageRef = ref(storage, `images/user/${file.name}`);
              ...
              <Box component="form" noValidate sx={{ mt: 3 }}>
                ...
                >
                  ...
                  >
                    <FormControlLabel
                      ...
                      value="User"
                      checked={type === "User"}
                      onChange={() => dispatch(SignupActions.type("User"))}
                      control={<Radio />}
                      label="User"
                    />
                    <FormControlLabel
                      ...
                      value="seller"
                      checked={type === "seller"}
                      onChange={() => dispatch(SignupActions.type("seller"))}
                      control={<Radio />}
                      label="Seller"
                    />
                  </RadioGroup>
                ...
                >
                  <Button
                    ...
                    onClick={sendOtpToNumberAndEmail}
                    disabled={isLoading}
                  >
                    {isLoading && (
                      <CircularProgress
